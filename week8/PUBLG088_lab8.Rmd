---
title: "PUBLG088 Lab 8: Tree-based Methods"
author: "Slava Mikhaylov"
output: html_document
---


This lab session is based on lab exercises in James et al. [Chapter 8].
...
Now we can the check error rate on the test data set using [`predict()`](http://bit.ly/R_predict) and calculating the mean square error.
