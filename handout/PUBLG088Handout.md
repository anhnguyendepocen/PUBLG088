...
9.  Before the lecture in Week 9 you need to email to the class using
    Moodle mailing list a maximum 200-word abstract discussing the
    article you plan to replicate, and what is your plan
    for improvement/extension. Your abstract must contain one sentence
    on how replicating this article will help you with your
    dissertation project.

10. In Week 10 you need to come to the seminar with a 2-page proposal
    outlining a clear replication and improvement plan.

11. Your paper should be proofread. Follow Harvard referencing style,
    using the citation style of the American Political Science Review.

12. This assignment is a version of the replication paper exercise at
...
13. Follow Gary King’s discussion in “Publication, Publication” for
    overall style, structure, and presentation of your paper.

14. You should use R Markdown to write your replication project.

15. Good examples of a replication exercise are (a) Gary King and
...
16. The final version of the paper is due on <span> 14 January
