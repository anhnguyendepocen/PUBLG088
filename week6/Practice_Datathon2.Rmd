...
You will be working in small groups on this exercise. You will have a week to complete the exercise. You will present your results in class on November 22nd.
...
For the datathon you will have to grab data from World Development Indicators database (note: basic tips in class). Using these data you are asked to address any issue of interest to you that involves extracting insights from data. Methodologically you should use **both** SVMs and unsupervised learning (at least the level covered in class) in your project.
